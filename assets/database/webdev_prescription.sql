...
CREATE TABLE IF NOT EXISTS `patient` (
  ...
  `firstName` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `lastName` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `pasword` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `patient` (`patientID`, `firstName`, `lastName`, `pasword`, `birthDate`, `gender`, `contactNumber`, `address`, `email`, `doctorID`, `healthCondition`, `allergies`, `currentMedication`, `knownDiseases`) VALUES
